...
public class AppealItemController {
    ...
    public void setAppealData(Appeal appeal) {
        ...
        if ("อนุมัติโดยอาจารย์ที่ปรึกษา คำร้องส่งต่อให้หัวหน้าภาควิชา".equals(appeal.getStatus()) || "อนุมัติโดยคณบดี คำร้องดำเนินการครบถ้วน".equals(appeal.getStatus())) {
            statusLabel.setTextFill(javafx.scene.paint.Color.GREEN); //สถานะเป็นอนุมัติ
        } else if("ปฏิเสธโดยอาจารย์ที่ปรึกษา คำร้องถูกปฏิเสธ".equals(appeal.getStatus()) || "ปฏิเสธโดยคณบดี คำร้องถูกปฏิเสธ".equals(appeal.getStatus())){
